...
const WriteReview = () => {
    ...
    const fetchSingleMovies = async () => {
        try {
            const response = await axios.get(`https://movies-api-cibz.onrender.com/api/movies/${imdbId}`)
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post("https://movies-api-cibz.onrender.com/api/reviews", { reviewBody: review, imdbId: imdbId });
